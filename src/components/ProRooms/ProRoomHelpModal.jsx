    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-[#0c0c16] border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 font-sans text-white my-8 overflow-hidden"
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-5 right-5 p-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white transition cursor-pointer border border-white/10"
          >
            <X size={18} />
          </button>
          ...
          <div className="space-y-1">
            ...
            <h2 className="text-xl sm:text-2xl font-black text-white flex items-center gap-2">
              <LifeBuoy size={22} className="text-[#00F0FF]" /> Pro Room Help & Support
            </h2>
          ...
          {/* DUAL SUPPORT TABS */}
          <div className="grid grid-cols-2 gap-2 bg-[#06060c] p-1.5 rounded-2xl border border-white/10">
            <button
