    ...
    <div className="min-h-screen bg-[#0B0C10] text-white flex flex-col justify-between">
      ...
      <section className="relative pt-40 pb-16 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <PageHeading
            eyebrow="AI Powered"
            title="AI Challenges"
            subtitle="Crack AI bugs, fix broken models, and debug machine learning pipelines across NLP, Deep Learning, and more."
            accent="pink"
            size="xl"
          />
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24 text-gray-500 px-6">
          No AI challenges yet — check back soon!
        </div>
      ) : (
        <motion.div
          layout
          ...
          {displayedChallenges.map((challenge, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="group relative bg-[#0f0f14] border border-white/5 rounded-2xl p-5 flex flex-col justify-between transition-all duration-300 hover:border-[#FF00C8]/20 hover:bg-[#111118]"
              >
                {/* Number */}
                <div className="absolute top-4 right-4 text-xs font-bold text-white/10 group-hover:text-[#FF00C8]/30 transition-all">
                ...
                <div>
                  ...
                  <h2 className="text-white font-bold text-base leading-snug mb-3 group-hover:text-[#FF00C8] transition-colors pr-6">
                    {challenge.title}
                  </h2>
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <button
                    onClick={() => navigate(`/ai-challenge/${challenge.id}`)}
...
export default AIPoweredChallenges;
